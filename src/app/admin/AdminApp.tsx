...
import { adminApi, getAdminKey, setAdminKey, clearAdminKey, type Stats } from './api';
    ...
    <div className="min-h-screen bg-[#2D0A6B] flex items-center justify-center px-6">
      <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-10 w-full max-w-[400px] text-center">
        ...
        <input
          ...
          className="w-full px-5 py-3.5 rounded-2xl border-2 border-gray-200 focus:border-[#F97316] outline-none font-semibold mb-4"
        />
